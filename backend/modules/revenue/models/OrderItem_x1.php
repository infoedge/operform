...
class OrderItem extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['ordersId', 'priceListId', 'isCancelled', 'recordBy', 'updatedBy'], 'integer'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'priceListId' => Yii::t('app', 'Price List ID'),
            'quantity' => Yii::t('app', 'Quantity'),
            'totalAmt' => Yii::t('app', 'Total Amt'),
            'isCancelled' => Yii::t('app', 'Is Cancelled'),
