...
use backend\modules\revenue\models\ProductTypeSearch;
...
class ProductTypeController extends Controller
{
    ...
    public function actionCreateCode($prodtypename){
        echo Json::encode(Yii::$app->useful->makeStrCode($prodtypename));
    }
    /**
