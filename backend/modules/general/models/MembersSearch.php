...
use backend\modules\general\models\Members;

/**
 * MembersSearch represents the model behind the search form of `backend\modules\general\models\Members`.
 */
class MembersSearch extends Members
{
    ...
    public function rules()
    {
        return [
            ...
            [['surname', 'otherNames', 'gender', 'dob', 'phoneNo', 'interests', 'recordDate', 'updateDate'], 'safe'],
        ];
    }
