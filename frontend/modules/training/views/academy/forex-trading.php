...
$this->title = Yii::t('app', 'Forex trading Academy');
...
<div class="books-default-index">
    ...
    <?php
        echo \lesha724\documentviewer\ViewerJsDocumentViewer::widget([
            'url' => Url::base().'/../modules/training/academyfiles/ForexTradingKnowledge.pdf', //url на ваш документ или http://example.com/test.odt
