...
use yii\helpers\Url;
$this->title = Yii::t('app', 'Online Business Academy');
...
<div class="books-default-index">
    ...
    <?php
        echo \lesha724\documentviewer\ViewerJsDocumentViewer::widget([
            'url' => Url::base().'/../modules/training/academyfiles/OnlineBusinessOpportunities.pdf', //url на ваш документ или http://example.com/test.odt
