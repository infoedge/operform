...
use yii\helpers\Url;
$this->title = Yii::t('app', 'Network Marketing Academy');
...
<div class="books-default-index">
    ...
    <?php
        echo \lesha724\documentviewer\ViewerJsDocumentViewer::widget([
            'url' => Url::base().'/../modules/training/academyfiles/NetworkMarketingKnowledge.pdf', //url на ваш документ или http://example.com/test.odt
